...
- [x] External regulatory links in source registries are limited to recognized official authority domains.
...
- This is an initial taxonomy and retrieval framework, not a complete regulatory database.
...
- Terminology mappings are conservative and require qualified community refinement.
- EU medicines regulation is broader than EMA; European Commission, EUR-Lex, EudraLex, and national sources may be controlling.
- FDA Warning Letters and Form FDA 483 observations are enforcement or inspection evidence, not universal binding regulations.
- NMPA notices, announcements, technical guidelines, and formal regulations must be distinguished by document type and legal effect.
